...
- Allow for adding line numbers to next actions using the `--line-number` command line argument. Closes #712.

## [1.12.0] - 2019-11-17

### Added

- Allow for opening URLs in next actions using the `--open-urls` command line argument. Closes #577.
...
- Allow for using the `groupby` option without argument to override a configured `groupby` option. Fixes #335.

## [1.11.0] - 2018-11-14

### Added

- Allow for hiding tasks with `h:1`. Closes #332.
